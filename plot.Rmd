...
**Tilanne:** `r progress` kansallispuistoista käyty! Käydyt puistot merkitty logolla ja käymättömät kysymysmerkillä. 
...
Kartta on tehty käyttäen R-paketteja `sp` ja `leaflet`. Koordinaatit osoitteesta: kartta.com/muut-kartat/suomen-kansallispuistot/.
