...
```{r eval=FALSE, fig.height=1.5, fig.width=6, include=FALSE}
# How many visited 
data %>%
...
p1 <- data %>%
  ...
  geom_bar(aes(fill = "Jo aiemmin käyty")) +
  ...
  ylab("Käydyt puistot") + xlab("Vuosi") + ggtitle("Vuosittain vieraillut puistot")
...
p2 <- data %>%
  ...
  scale_color_manual(name = "Puiston tyyppi", values = c("steelblue4", "#9ACD32")) +
